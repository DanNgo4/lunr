...
const Dashboard = () => {
  ...
  return (
    <>
      <Head>
        <title>Lunr Dashboard</title>
      </Head>

      <main className="grid grid-cols-[10%_90%] min-h-screen text-xs max-w-[100vw]">
        <article className="flex flex-col h-full bg-gray-100 ">
          <section className="flex flex-col">
            <svg className="w-auto my-4 mx-3npm" viewBox="0 0 117 42" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <article className="bg-white">
          <section className="grid grid-rows-[8%_92%] h-full">
            ...
            <div className="grid grid-cols-[80%_20%] 3xl:grid-cols-[85%_15%] w-full">
